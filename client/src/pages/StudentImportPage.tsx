...
export function StudentImportPage() {
  ...
  const [result, setResult] = useState<ValidateStudentImportResponse | null>(
    null,
  );
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Upload an Excel file with columns: studentName, scholarId,
            parentName, parentPhoneNumber, PAN, class, section.
          </p>
        </div>
        <Link
          to="/students"
      ...
      <Card className="p-6">
        ...
        <CardDescription className="mb-3">
          Use .xlsx or .xls. First row must be headers. Class must match app
          values (e.g. 10th, Nursery). Section is A–D.
        </CardDescription>
        <p className="mb-4 text-sm">
          <a
            href="/sample-students-import.xlsx"
            download="sample-students-import.xlsx"
        ...
        <Card className="overflow-hidden p-0!">
          <div className="border-b border-border px-6 py-4">
            ...
            <CardDescription>
              ...
              <span
                className={
                  invalidCount > 0 ? "text-red-700" : "text-muted-foreground"
                }
              >
          ...
          <div className="flex flex-col gap-3 border-t border-border px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-sm text-muted-foreground">
              Only valid rows are imported. Fix invalid rows in the sheet and
